<template>
  <main>
    ...
    <h1>
      <a href="https://github.com/Justineo/vue-echarts">Vue-ECharts</a>
    </h1>
    <p class="desc">
    ...
    <section v-if="expand.radar">
      <figure>
        <chart :options="scoreRadar" :init-options="initOptions"/>
      </figure>
      <p>
        <label>
    ...
    <footer>
      ...
      |
      <a href="//github.com/Justineo/vue-echarts">
        View on GitHub
      </a>
    </footer>
